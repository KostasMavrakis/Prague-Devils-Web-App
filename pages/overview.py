                   ...
                   html.Div(
                       [
                           ...
                           dbc.Row(
                               ...
                               className="mb-2",
                               justify="center",  # Aligns cards in the row
                           ),
...
def update_dashboard(selected_season):
   ...
   fig.update_traces(
       textinfo="percent+label",  # Shows percentages inside, labels outside
       textposition="inside",
   ...
   fig.update_layout(
       ...
       height=700,  # Increases height for larger pie chart
       width=700,   # Increases width for larger pie chart
   )
   fig.update_traces(
       textfont=dict(
           size=18,  # Increases font size for labels
           family="Arial",
           color="#4c4b4b",
